...
export type OutboxEventScalarWhereWithAggregatesInput = {
	...
	transactionId?: Prisma.StringWithAggregatesFilter<'OutboxEvent'> | string;
...
export type OutboxEventUpdateInput = {
	...
	failedAt?:
		...
		| string
		| null;
	transaction?: Prisma.TransactionUpdateOneRequiredWithoutOutboxEventsNestedInput;
};
...
export type OutboxEventCreateWithoutTransactionInput = {
	id: string;
	topic: string;
	payload: Prisma.JsonNullValueInput | runtime.InputJsonValue;
	processed?: boolean;
...
export interface OutboxEventFieldRefs {
	...
	readonly transactionId: Prisma.FieldRef<'OutboxEvent', 'String'>;
