	...
	Prisma.PrismaPromise<
		Array<
			Prisma.PickEnumerable<BalanceGroupByOutputType, T['by']> & {
				[P in keyof T &
					keyof BalanceGroupByOutputType]: P extends '_count'
					? T[P] extends boolean
						? number
						: Prisma.GetScalarType<
								T[P],
								BalanceGroupByOutputType[P]
							>
...
export type BalanceWhereUniqueInput = Prisma.AtLeast<
	{
		...
		updatedAt?: Prisma.DateTimeFilter<'Balance'> | Date | string;
		blockedAt?:
			| Prisma.DateTimeNullableFilter<'Balance'>
			| Date
			| string
			| null;
		account?: Prisma.XOR<
...
export type BalanceScalarWhereWithAggregatesInput = {
	...
	blockedAt?:
		| Prisma.DateTimeNullableWithAggregatesFilter<'Balance'>
		| Date
		| string
		| null;
};
	...
	count<T extends BalanceCountArgs>(
		...
		T extends runtime.Types.Utils.Record<'select', any>
			? T['select'] extends true
				...
				: Prisma.GetScalarType<
						T['select'],
						BalanceCountAggregateOutputType
					>
			: number
	>;
...
export interface BalanceFieldRefs {
	...
	readonly blockedAt: Prisma.FieldRef<'Balance', 'DateTime'>;
}
